public class Ballon extends Aircraft implements Flyable {
    ...
    public void updateConditions() {
        ...
        if (currentWeather.equals("RAIN")) {
            Avaj.pw.println(this.getName() + "(" + this.id + "):" + " It's rain now! AAAAAAAAAAaaaaaaaa!");
            ...
            if (this.coordinates.getHeight() < 1) {
                ...
                Avaj.pw.println("It's snow now! We all gonna die!");
                ...
                Avaj.pw.println("It's sun now! I don't know what to do");
